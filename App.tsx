    ...
    <div className="relative w-full overflow-x-hidden min-h-screen">
      ...
      <nav className={`fixed top-0 w-full z-[100] transition-all duration-500 ${scrolled ? 'bg-deep-navy/95 backdrop-blur-xl py-3 md:py-4 border-b border-white/[0.02] shadow-2xl' : 'py-5 md:py-8 border-b border-transparent'}`}>
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 flex justify-between items-center gap-2">
          <div className="flex items-center gap-1.5 sm:gap-3 md:gap-4 cursor-pointer group flex-shrink-0" onClick={(e) => scrollToSection(e, 'top')}>
            <LocalLogo className="h-7 sm:h-8 md:h-12 w-auto group-hover:scale-110" />
            <span className="text-white font-cinzel font-bold text-[9px] sm:text-sm md:text-xl tracking-[0.1em] sm:tracking-[0.2em] uppercase whitespace-nowrap">Protocolo Odonto</span>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-10 flex-shrink-0">
            ...
            <button onClick={() => setIsModalOpen(true)} className="bg-gold-metallic btn-shimmer text-black px-8 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest hover:scale-105 transition-all shadow-lg font-black flex items-center gap-2">
          ...
          <button 
            ...
            className="lg:hidden bg-gold-metallic btn-shimmer text-black px-3 sm:px-5 py-2 sm:py-2.5 rounded-full text-[8px] sm:text-[9px] font-bold uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-lg font-black flex-shrink-0 flex items-center gap-1.5"
          >
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 md:gap-16 items-center w-full">
          <div className="space-y-6 md:space-y-10 text-center lg:text-left relative z-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center lg:justify-start">
              <button onClick={() => setIsModalOpen(true)} className="bg-gold-metallic btn-shimmer text-black px-6 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-black text-base md:text-lg hover:scale-105 transition-all shadow-2xl flex items-center justify-center gap-3 tracking-wide">
      ...
      <section className="py-20 md:py-32 bg-slate-950 relative overflow-hidden">
         <div className="max-w-4xl mx-auto px-4 md:px-6 text-center relative z-10">
            ...
            <p className="text-white/60 text-lg md:text-xl mb-12 max-w-2xl mx-auto italic">O amadorismo digital é o maior ralo de lucro do mercado odontológico atual. Recupere o controle da sua agenda hoje.</p>
            <button 
              onClick={() => setIsModalOpen(true)} 
              className="bg-gold-metallic btn-shimmer text-black px-12 md:px-20 py-5 md:py-6 rounded-2xl font-black text-lg md:text-2xl hover:scale-110 active:scale-95 transition-all shadow-[0_0_50px_rgba(212,175,55,0.4)] flex items-center justify-center gap-4 mx-auto"
            >
      ...
      <footer className="py-12 md:py-20 border-t border-white/5 bg-deep-navy overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-10 text-center md:text-left">
          <div className="flex items-center gap-3 md:gap-4 cursor-pointer group flex-shrink-0" onClick={(e) => scrollToSection(e, 'top')}>
            <LocalLogo className="h-8 md:h-10 w-auto group-hover:rotate-12 transition-transform duration-500" />
            <span className="text-white font-cinzel font-bold tracking-[0.2em] text-xs md:text-sm uppercase whitespace-nowrap">Protocolo Odonto</span>
          </div>
          ...
          <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-white/20 font-black flex-shrink-0">© 2026 Protocolo Odonto • Engenharia de Aquisição Ética</p>
        </div>
      </footer>

      {/* Floating WA Button */}
      <a 
        href={`https://wa.me/${WHATS_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre o Protocolo Odonto.')}`} 
        target="_blank" 
        rel="noopener noreferrer" 
        className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[150] bg-[#25D366] text-white p-4 md:p-5 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all whatsapp-pulse flex items-center justify-center"
      >
